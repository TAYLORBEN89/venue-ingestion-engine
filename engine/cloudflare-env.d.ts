/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 4e27c457871ac0002bcae1e3eda252d7)
...
interface __BaseEnv_CloudflareEnv {
	...
	/** Set to "true" to fall back to LLM page scraping when no structured feed is found. */
	ENABLE_AI_SCRAPE_FALLBACK: string;
	/** Optional Ticketmaster Discovery API key for event poster images. */
	TICKETMASTER_API_KEY?: string;
	/** Set to "false" to skip auto-research artist creation for unmatched bands. */
	ENABLE_AUTO_ARTIST_GENERATION?: string;
	/**
	 * Shared secret for HTTP routes (Bearer / X-Ingestion-Secret).
	 * Must match admin Worker's INGESTION_API_SECRET. Cron does not use this.
	 */
	INGESTION_API_SECRET?: string;
	SCHEDULER_WORKFLOW: Workflow<Parameters<import("./src/index").IngestionSchedulerWorkflow['run']>[0]['payload']>;
	VENUE_INGESTION_WORKFLOW: Workflow<Parameters<import("./src/index").VenueIngestionWorkflow['run']>[0]['payload']>;
}
